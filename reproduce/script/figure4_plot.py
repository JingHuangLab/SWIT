...
for rdx,rcpt_name in enumerate(rcpt_name_lst):
    ...
    ### Read data
    chem_df = pd.read_csv("../data/score_split/score_split_"+rcpt_name+"_top1000.txt",sep="\t")
    round2_df = pd.read_csv("../data/score_split/score_split_"+rcpt_name+"_round2_top1000.txt",sep="\t")#lip5_2
    if rcpt_name =="ampc":
        std_name="AmpC"
    elif rcpt_name=="d4":
        std_name='D$_{4}$'
    ...
    ### Create category name for distinction
    ...
    ### Create different categories for easy coloring
